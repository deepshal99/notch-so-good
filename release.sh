...
echo "  4. Update Homebrew cask (Casks/notch-so-good.rb + deepshal99/homebrew-tap):"
echo "       version $VERSION, sha256 $(shasum -a 256 "$ZIP_NAME" | cut -d' ' -f1)"
echo "  5. Done! Existing users will get the update automatically."
